...
class _PyqChapterListScreenState extends State<PyqChapterListScreen> {
          ...
          Container(
            ...
            child: DropdownButtonHideUnderline(
              child: DropdownButton<String>(
                ...
                icon:
                    const Icon(Icons.arrow_drop_down, color: Color(0xFFE57C23)),
  ...
  Widget _buildChapterListItem(BuildContext context, Chapter chapter) {
    ...
    Color completionColor = chapter.completionStats.startsWith('0/')
        ? Colors.white38
        : Colors.orangeAccent;
